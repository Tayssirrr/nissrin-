	...
	<body>
		...
		<section id="home" class="welcome-hero">
			...
			<div class="top-area">
				<header>
					...
					<button class="login_btn"> RESERVATION </button>
				</header><!--/.header-area-->
		...
		<section id="featured-cars" class="featured-cars">
			<div class="container">
				...
				<div class="featured-cars-content images">
					{{-- <div class="row">
							...
							<div class="single-featured-cars">
								<div class="featured-img-box">
									<div class="featured-cars-img">
										<img src="storage/{{$voiture->image}}" alt="cars"/>
									</div>
									<div class="featured-model-info">
										<p>
											model: {{$voiture->Model}}
											<span class="featured-mi-span">{{$voiture->marque}}</span> 
					...
					<ul>
						...
						<li class="car">
						   ...
						   <span>{{$voiture->marque}} {{$voiture->Model}}</span>
						   <span class="prix"> 400 € par jour </span>
						   <a href="btn btnresrvation" class="btnresrvation"> RESERVATION </a>
						</li>
						@endforeach
					</ul>
